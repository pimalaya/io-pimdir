...
The io-replica follow-up stays unchecked: `engine-merge` folded io-replica into this crate, where a placement carries its sort key on the ordinary insert, so the task closed by disappearing rather than by landing there.
