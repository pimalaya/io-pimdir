...
> **Superseded by `duplicate-link-id-mints-an-item`** (2026-08-28): the column this change added is gone, the second copy being stored as an item of its own. The refusal to repoint a binding is the part that survives.
